...
ALTER TABLE adjudication.Determination
  DROP COLUMN Infected,
  DROP COLUMN InfectedDate,
  DROP COLUMN Comment,
  ADD COLUMN Hiv1Infected VARCHAR(200),
  ADD COLUMN Hiv2Infected VARCHAR(200),
  ADD COLUMN Hiv1InfDate TIMESTAMP,
  ADD COLUMN Hiv2InfDate TIMESTAMP,
  ADD COLUMN Hiv1Comment VARCHAR(500),
  ADD COLUMN Hiv2Comment VARCHAR(500);

/* adjudication-15.22-15.23.sql */

ALTER TABLE adjudication.Determination
  DROP COLUMN Hiv1InfDate,
  DROP COLUMN Hiv2InfDate,
  ADD COLUMN Hiv1InfectedVisit DOUBLE PRECISION,
  ADD COLUMN Hiv2InfectedVisit DOUBLE PRECISION;

ALTER TABLE adjudication.Determination RENAME COLUMN Adjudicator TO AdjudicatorUserId;