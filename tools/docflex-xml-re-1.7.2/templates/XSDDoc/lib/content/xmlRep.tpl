...
<STOCK_SECTIONS>
	...
	<FOLDER>
		...
		<BODY>
			<ELEMENT_ITER>
				...
				SORTING='by-expr'
				SORTING_KEY={expr='hasAttr("name") ? callStockSection("Attribute Name") \n                : getAttrQNameValue("ref").toXMLName()',ascending,case_sensitive}
	...
	<FOLDER>
		...
		<BODY>
			<AREA_SEC>
				COND='! getBooleanParam("abbreviateAttrValue") && hasAttr("fixed")'
				BREAK_PARENT_BLOCK='when-executed'
				<AREA>
					<CTRL_GROUP>
						FMT={
...
CHECKSUM='zOepqdhD00vkEskqNezEq1OsujWmxzU63vnfewOxVFs'
</DOCFLEX_TEMPLATE>