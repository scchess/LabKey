...
<TEMPLATE_PARAMS>
	...
	PARAM={
		param.name='deriv.simpleContent.annotation';
...
<STOCK_SECTIONS>
	...
	<FOLDER>
		...
		<BODY>
			...
			<SS_CALL>
				COND='getBooleanParam("deriv.simpleContent.annotation")'
				FMT={
	...
	<FOLDER>
		...
		<BODY>
			<TEMPLATE_CALL>
				...
				PASSED_PARAMS={
					'facet.annotation','getBooleanParam("deriv.simpleContent.annotation")';
				}
			</TEMPLATE_CALL>
		</BODY>
	</FOLDER>
...
CHECKSUM='VuaEwqSWdSeyOz9dqPv3Qo4UoCOcGJNAUfvY2ARup3M'
</DOCFLEX_TEMPLATE>