...
<ROOT>
	...
	<FOLDER>
		...
		<FOOTER>
			<AREA_SEC>
				COND='checkStockSectionOutput("Related Elements")'
				FMT={
					sec.outputStyle='pars';
				}
				<AREA>
	...
	<FOLDER>
		...
		<BODY>
					...
					<FOLDER>
						...
						<BODY>
							<ELEMENT_ITER>
								...
								SORTING='by-expr'
								SORTING_KEY={expr='findPredecessorByType("xs:group").callStockSection("XMLName")',ascending,case_sensitive}
								<BODY>
									<AREA_SEC>
										<AREA>
											<CTRL_GROUP>
			...
			<FOLDER>
				...
				COND='hasParamValue("doc.comp.lists.defs", "always")\n||\nhasParamValue("doc.comp.lists.defs", "multiple")\n&&\ngetIntParam("usageCount") > 1'
					...
					<CTRL_GROUP>
						<CTRLS>
							<TEMPLATE_CALL_CTRL>
								...
								PASSED_PARAMS={
									'context_comp_id','instanceOf("xs:%localSimpleType | xs:%localComplexType")\n  ? contextElement.id : rootElement.id';
								}
							</TEMPLATE_CALL_CTRL>
						</CTRLS>
					</CTRL_GROUP>
			...
			<FOLDER>
				...
				<BODY>
					<ELEMENT_ITER>
						...
						TARGET_ET='xs:%element'
						SCOPE='custom'
						ELEMENT_ENUM_EXPR='getVar ("parentsBySubstitutions").toEnum()'
						BREAK_PARENT_BLOCK='when-executed'
						<BODY>
							<AREA_SEC>
								<AREA>
									...
									<CTRL_GROUP>
										...
										<CTRLS>
											<SS_CALL_CTRL>
												...
												SS_NAME='Element List Column'
												PARAMS_EXPR='v = getVar ("parentsBySubstitutions").toVector();\nN = v.size();\n\nArray (\n  v.subVector (0, (N + 1) / 2),\n  N == 1\n)'
											</SS_CALL_CTRL>
											<SS_CALL_CTRL>
												FMT={
													ctrl.size.width='272.3';
						...
						<AREA>
							<CTRL_GROUP>
								<CTRLS>
									...
									<DATA_CTRL>
										FORMULA='"(" + getVar ("parentsBySubstitutions").toVector().size() + ")"'
									</DATA_CTRL>
									<DELIMITER>
										FMT={
											txtfl.delimiter.type='none';
...
CHECKSUM='Rd8CDl9QYKf5wtGPJlGWh8OWZWZHgncRTiI2j?OqJM0'
</DOCFLEX_TEMPLATE>