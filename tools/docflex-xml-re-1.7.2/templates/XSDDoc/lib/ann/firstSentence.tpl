...
<STOCK_SECTIONS>
	...
	<FOLDER>
		DESCR='generates a single HTML output from the annotations specified in the element'
		MATCHING_ETS={'xs:%annotated';'xs:schema'}
		SS_NAME='HTMLDoc'
		<BODY>
			<ELEMENT_ITER>
...
CHECKSUM='DPVzZYE6YRs1MxVh6jDt+qyCBVsAlNe3JA8BtjIYrBc'
</DOCFLEX_TEMPLATE>