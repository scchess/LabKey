...
<ROOT>
	<ELEMENT_ITER>
		...
		SCOPE='custom'
		ELEMENT_ENUM_EXPR='filter = hasParamValue("doc.comp.attributes", "own") ?\n  BooleanQuery (\n    findPredecessorByType("xs:%element;xs:complexType;xs:attributeGroup").id \n    == rootElement.id\n  ) : null;\n\nfindElementsByKey ("content-model-attributes", getParam("contentModelKey"), filter)'
		SORTING='by-expr'
		...
		<BODY>
			...
			<FOLDER>
				DESCR='if this is an attribute wildcard'
								...
								<AREA>
									<CTRL_GROUP>
										...
										<CTRLS>
											...
											<DATA_CTRL>
												FORMULA='getIntParam("ownAttributeCount") + getParam("ownAnyAttribute").toInt()'
											</DATA_CTRL>
											<LABEL>
												TEXT='/'
											</LABEL>
											<DATA_CTRL>
												FORMULA='getIntParam("attributeCount") + getParam("anyAttribute").toInt()'
											</DATA_CTRL>
											<LABEL>
												TEXT=')'
											</LABEL>
			...
			<FOLDER>
				...
				<BODY>
					...
					<AREA_SEC>
						DESCR='See "Processing | Context Element" tab'
						COND='getBooleanParam("doc.comp.attributes.profile.fixed")\n\n// see also "Context Element" tab'
						CONTEXT_ELEMENT_EXPR='globalAttr = stockSection.getElementVar("globalAttr");\nglobalAttr.hasAttr("fixed") ? globalAttr : null'
						MATCHING_ET='xs:%attribute'
						<AREA>
							<CTRL_GROUP>
								FMT={
		...
		<BODY>
			...
			<TEMPLATE_CALL>
				...
				PASSED_PARAMS={
					...
					'deriv.simpleContent.annotation','getBooleanParam("doc.comp.attributes.type.deriv.simpleContent.annotation")';
				}
			</TEMPLATE_CALL>
		</BODY>
		<HEADER>
...
CHECKSUM='RQIyI+FlY94J92J8q6XY7hYtRnvBGdTjyG?HFB7VCLM'
</DOCFLEX_TEMPLATE>