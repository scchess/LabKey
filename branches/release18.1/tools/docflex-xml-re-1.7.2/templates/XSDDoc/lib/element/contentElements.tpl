...
<ROOT>
	<ELEMENT_ITER>
		...
		SCOPE='custom'
		ELEMENT_ENUM_EXPR='filter = hasParamValue("doc.comp.contentElements", "own") ?\n  BooleanQuery (\n    findPredecessorByType("xs:%element;xs:complexType;xs:group").id \n    == rootElement.id\n  ) : null;\n\nfindElementsByKey (\n  "content-model-elements",\n  getParam("contentModelKey"),\n  filter\n)'
		SORTING='by-expr'
		...
		<BODY>
			...
			<FOLDER>
				DESCR='if this is an element wildcard'
				MATCHING_ET='xs:any'
				<HTARGET>
					HKEYS={
						'contextElement.id';
								...
								<AREA>
									<CTRL_GROUP>
										...
										<CTRLS>
											...
											<DATA_CTRL>
												FORMULA='getIntParam("ownElementCount") + getParam("ownAnyElement").toInt()'
											</DATA_CTRL>
											<LABEL>
												TEXT='/'
											</LABEL>
											<DATA_CTRL>
												FORMULA='getIntParam("elementCount") + getParam("anyElement").toInt()'
											</DATA_CTRL>
											<LABEL>
												TEXT=')'
											</LABEL>
					...
					<FOLDER>
						...
						<BODY>
							...
							<AREA_SEC>
								...
								CONTEXT_ELEMENT_EXPR='globalElement = stockSection.getElementVar("globalElement");\nglobalElement.hasAttr("fixed") ? globalElement : null'
								MATCHING_ET='xs:element'
								FMT={
									trow.align.vert='Top';
								}
		...
		<BODY>
			...
			<TEMPLATE_CALL>
				...
				PASSED_PARAMS={
					...
					'deriv.simpleContent.annotation','getBooleanParam("doc.comp.contentElements.type.deriv.simpleContent.annotation")';
				}
			</TEMPLATE_CALL>
		</BODY>
		<HEADER>
...
CHECKSUM='dFOMDvOJ0U?V4b0+KZlxKEL6toxus3QKd4+0BAWDpmY'
</DOCFLEX_TEMPLATE>