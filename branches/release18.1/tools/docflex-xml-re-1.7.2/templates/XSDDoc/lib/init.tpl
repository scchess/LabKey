...
<ROOT>
	...
	<FOLDER>
		...
		<BODY>
			...
			<FOLDER>
				DESCR='\'group-usage\', \'attributeGroup-usage\', \'attribute-usage\'\n--\n\'group-usage\' allows finding all local <xs:group> elements where a given global element group is specified by reference. The hash-key is the group\'s QName (namespaceURI, name)\n--\n\'attributeGroup-usage\' allows finding all local <xs:attributeGroup> elements where a given global attribute group is specified by reference. The hash-key is the attribute group\'s QName (namespaceURI, name)\n--\n\'attribute-usage\' allows finding all local <xs:attribute> elements where a given global attribute is specified by reference. The hash-key is the attribute\'s QName (namespaceURI, name)'
	...
	<FOLDER>
		...
		<BODY>
			<ELEMENT_ITER>
				...
				SCOPE='simple-location-rules'
				RULES={
					'* -> (xs:simpleType|xs:simpleType%xs:localSimpleType)';
				}
				<BODY>
					<ELEMENT_ITER>
			...
			<ELEMENT_ITER>
				...
				SCOPE='simple-location-rules'
				RULES={
					'* -> (xs:complexType|xs:complexType%xs:localComplexType)';
				}
				<BODY>
					<ELEMENT_ITER>
						DESCR='those types within the redefined schema are renamed by adding \'$ORIGINAL\' suffix\n(see tab: Processing | Init/Step/Finish | Step Expression)'
			...
			<ELEMENT_ITER>
				...
				SCOPE='simple-location-rules'
				RULES={
					'* -> (xs:attributeGroup|xs:attributeGroup%xs:attributeGroupRef)';
				}
				<BODY>
					<ELEMENT_ITER>
...
CHECKSUM='Vm8PGUvnw4t0?ore1rXdANyNcQn4KJteDZYt0+eGz8w'
</DOCFLEX_TEMPLATE>