...
<STOCK_SECTIONS>
	<FOLDER>
		...
		<BODY>
			<SS_CALL>
				DESCR='process a restriction contained in it'
				CONTEXT_ELEMENT_EXPR='findElementByLPath("xs:simpleContent/xs:restriction")'
			...
			<SS_CALL>
				...
				CONTEXT_ELEMENT_EXPR='findElementByLPath("xs:simpleContent/xs:extension")'
						...
						<AREA>
							<CTRL_GROUP>
								<CTRLS>
									...
									<SS_CALL_CTRL>
										SS_NAME='typeByQName'
										PARAMS_EXPR='Array ("enum", true, getAttrQNameValue("base"))'
									</SS_CALL_CTRL>
								</CTRLS>
							</CTRL_GROUP>
						</AREA>
	...
	<FOLDER>
		...
		<BODY>
			<FOLDER>
				...
				CONTEXT_ELEMENT_EXPR='findElementByKey ("types", stockSection.params[2])'
					...
					<CTRL_GROUP>
						<CTRLS>
							<DATA_CTRL>
								<DOC_HLINK>
									HKEYS={
										'findElementByKey ("types", stockSection.params[2]).id';
										'"detail"';
									}
								</DOC_HLINK>
...
CHECKSUM='VU7K5HVq1Uy5kRH0DLmzX?GGpachl46B8guOIxPOyKk'
</DOCFLEX_TEMPLATE>