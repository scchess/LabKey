...
#
####################################################
# Upgrade testing script for CentOS. Here is how to use it 
# 
# 1. Start a cloud server on Rackspace
#       - Name the server "centos-test-01"
...
# 3. Log in to the cloud server as the root user (password will come via email)
...
yum install postgresql84.x86_64 postgresql84-server.x86_64 postgresql84-jdbc.x86_64
...
export JAVA_HOME=/labkey/apps/jdk1.6.0_23
