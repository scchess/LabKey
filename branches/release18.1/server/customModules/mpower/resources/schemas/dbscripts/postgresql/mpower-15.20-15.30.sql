...
(
    ...
    RaceWhite BOOLEAN NOT NULL DEFAULT FALSE,
    RaceBlack BOOLEAN NOT NULL DEFAULT FALSE,
    RaceNativeAmerican BOOLEAN NOT NULL DEFAULT FALSE,
    RaceAsian BOOLEAN NOT NULL DEFAULT FALSE,
    RaceHawaiian BOOLEAN NOT NULL DEFAULT FALSE,
    RaceOther BOOLEAN NOT NULL DEFAULT FALSE,
    RaceHispanic BOOLEAN NOT NULL DEFAULT FALSE,
    HispanicOrigin INTEGER,
    HispanicOriginOther VARCHAR(64),

    ZipCode INTEGER,
    EducationLevel INTEGER,
    MaritalStatus INTEGER,
    EmploymentStatus INTEGER,
    EmploymentStatusOther VARCHAR(64),
...
(
    ...
    CONSTRAINT FK_PatientId_PatientDemographics FOREIGN KEY (PatientId) REFERENCES mpower.PatientDemographics(PatientId)
);
...
(
    ...
    TreatmentWithinYear BOOLEAN NOT NULL DEFAULT FALSE,
    PrimaryClinician INTEGER,
    CancerSpreadBeyondProstate BOOLEAN NOT NULL DEFAULT FALSE,
    SpreadToLymphs BOOLEAN NOT NULL DEFAULT FALSE,
    SpreadToBones BOOLEAN NOT NULL DEFAULT FALSE,
    SpreadToOrgans BOOLEAN NOT NULL DEFAULT FALSE,
    OrgansSpreadTo VARCHAR(500),
    SpreadToDontKnow BOOLEAN NOT NULL DEFAULT FALSE,
...
(
    ...
    PatientId ENTITYID NOT NULL,
    AlternateTherapySpecialDiet BOOLEAN NOT NULL DEFAULT FALSE,
    AlternateTherapyDietSupplement BOOLEAN NOT NULL DEFAULT FALSE,
    AlternateTherapyVitamin BOOLEAN NOT NULL DEFAULT FALSE,
    AlternateTherapyHomeopathy BOOLEAN NOT NULL DEFAULT FALSE,
    AlternateTherapyPhysical BOOLEAN NOT NULL DEFAULT FALSE,
    AlternateTherapyOriental BOOLEAN NOT NULL DEFAULT FALSE,
    AlternateTherapyPsychotherapy BOOLEAN NOT NULL DEFAULT FALSE,
    AlternateTherapyPrayer BOOLEAN NOT NULL DEFAULT FALSE,
    AlternateTherapyFaith BOOLEAN NOT NULL DEFAULT FALSE,
    AlternateTherapyMind BOOLEAN NOT NULL DEFAULT FALSE,
    AlternateTherapyOther VARCHAR(256),
    AlternateTherapyNone BOOLEAN NOT NULL DEFAULT FALSE,

    Cigarettes BOOLEAN NOT NULL DEFAULT FALSE,
